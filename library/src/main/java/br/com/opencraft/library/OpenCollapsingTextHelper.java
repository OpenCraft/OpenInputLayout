...
public class OpenCollapsingTextHelper {
    ...
    public OpenCollapsingTextHelper(View view, AttributeSet attrs) {
        mView = view;
        mAttrs = attrs;
    ...
    void setCollapsedTextAppearance(@StyleRes int resId) {
    ...
    void setExpandedTextAppearance(int resId) {
        TypedArray a = mView.getContext().getTheme().obtainStyledAttributes(
                mAttrs,
                android.support.v7.appcompat.R.styleable.TextAppearance,
                0, 0);
        if (a.hasValue(android.support.v7.appcompat.R.styleable.TextAppearance_android_textColor)) {
    ...
    private static float lerp(float startValue, float endValue, float fraction,
        ...
        return OpenAnimationUtils.lerp(startValue, endValue, fraction);
    }
